...
;  (= '(0 1 4 9 16 25) (map (fn [x] (* x x) (range 6))(for [x (range 6)]  __))
  ...
  "And also filtering"
  ;(= '(1 3 5 7 9) (filter odd? (range 10))  (for [x __ :when (odd? x)]  x))
...
;  (= '(1 9 25 49 81) (map (fn [x] (* x x)) (filter odd? (range 10)) (for [x (range 10) :when __] __))
